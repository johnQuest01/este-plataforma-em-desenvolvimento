...
export default function EntryPage() {
  ...
  const handleChange = (field: string, value: string) => {
    ...
    if (field === 'document') finalValue = personType === 'fisica' ? masks.cpf(value) : masks.cnpj(value);
        ...
        <form onSubmit={handleRegister} className="flex flex-col gap-4">
          ...
          <div className="space-y-3">
            ...
            <div className="relative group">
              ...
              <input required type="text" inputMode="numeric" placeholder={personType === 'fisica' ? 'CPF' : 'CNPJ'} value={formData.document} onChange={e => handleChange('document', e.target.value)} className="w-full h-12 pl-11 pr-4 bg-gray-50 border border-gray-200 rounded-xl text-sm font-bold outline-none focus:border-[#5874f6] transition-all" />
            </div>
            <div className="relative group">
