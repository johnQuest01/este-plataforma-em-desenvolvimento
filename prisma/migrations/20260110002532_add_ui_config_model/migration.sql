...
CREATE TABLE "GuardianConfig" (
    ...
    CONSTRAINT "GuardianConfig_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "GuardianConfig_key_key" ON "GuardianConfig"("key");

-- CreateIndex
CREATE UNIQUE INDEX "UIConfig_pageSlug_key" ON "UIConfig"("pageSlug");
